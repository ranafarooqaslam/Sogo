<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptCustomerStatment.aspx.cs" Inherits="Forms_RptCustomerStatment" Title="SAMS: Party Statement" %>
                        ...
                        <ContentTemplate>
                            <table>
                                <tr>
                                    ...
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="Label2" runat="server" Text="Data Type" Width="73px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
                                    <td style="height: 25px" align="left">
                                        <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal" Width="350px">
                                            <asp:ListItem Value="0" Text="All" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="1" Text="+ve Balance"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="-ve Balance"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <tr>
