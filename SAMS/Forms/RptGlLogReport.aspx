...
<strong><asp:Label id="lbltoLocation" runat="server" Width="73px" Text="Location"></asp:Label></strong></TD><TD align=left></TD><TD style="HEIGHT: 25px" align=left><asp:DropDownList id="drpDistributor" runat="server" Width="200px">
    </asp:DropDownList></TD></TR><TR><TD align=left></TD><TD align=left>
    <strong><asp:Label id="Label1" runat="server" Width="104px" Text="Voucher Type" __designer:dtid="5066549580791825" __designer:wfdid="w4"></asp:Label></strong></TD><TD align=left></TD><TD style="HEIGHT: 25px" align=left><asp:DropDownList id="DrpVoucherType" runat="server" Width="200px" __designer:dtid="5066549580791827" __designer:wfdid="w2">
                                        </asp:DropDownList></TD></TR><TR><TD align=left></TD><TD align=left>
                                        <strong><asp:Label id="Label6" runat="server" Width="104px" Text="User Name" __designer:dtid="5066549580791837" __designer:wfdid="w3"></asp:Label></strong></TD><TD align=left></TD><TD style="HEIGHT: 25px" align=left><asp:DropDownList id="DrpUser" runat="server" Width="200px" __designer:dtid="4503599627370527" __designer:wfdid="w1">
                                </asp:DropDownList></TD></TR><TR><TD align=left></TD><TD align=left>
                                <strong><asp:Label id="Label2" runat="server" Width="70px" Height="13px" Text="Filter On" __designer:wfdid="w1"></asp:Label></strong></TD><TD align=left></TD><TD style="HEIGHT: 25px" align=left><asp:RadioButtonList id="rblFilter" runat="server" Width="200px" __designer:wfdid="w2" RepeatDirection="Horizontal"><asp:ListItem Selected="True" Value="0">Entry Date</asp:ListItem>
