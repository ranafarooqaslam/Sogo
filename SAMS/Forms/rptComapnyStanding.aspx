<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="rptComapnyStanding.aspx.cs" Inherits="Forms_rptComapnyStanding" Title="SAMS: Company Standing" %>
                        ...
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="Label4" runat="server" Height="13px" Text="Up to" Width="80px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
