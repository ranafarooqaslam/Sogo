<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="rptLastSales.aspx.cs" Inherits="Forms_rptLastSales" Title="SAMS: Outlet Last Sales Report" %>
                        ...
                        <ContentTemplate>
                            <table>    
                                <tr>
                                    ...
                                    <td style="height: 25px" align="left">
                                        <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal">
                                            <asp:ListItem Value="0" Text="Without Amount" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="1" Text="With Amount"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="Label1" runat="server" Text="City" Width="73px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
                                    <td style="height: 25px" align="left">
