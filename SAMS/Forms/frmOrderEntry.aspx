            ...
            <table width="100%">
                <tr>
                    <td align="left">
                        <div style="left: 120px; position: absolute; top: 190px; z-index: 999;">
                            <asp:Panel ID="Panel1" runat="server" Width="327px" Height="237px" BorderWidth="1px"
                                ...
                                <table style="border-right: #ffffff thin groove; border-top: #ffffff thin groove; border-left: #ffffff thin groove; width: 99%; border-bottom: #ffffff thin groove">
                                    <tbody>
                                        <tr>
                                            <td style="border-bottom: black thin solid" align="left" colspan="2">&nbsp;<strong>Select Customer from List Press Enter</strong>
                                            </td>
                        ...
                        <div style="z-index: 101; left: 500px; width: 100px; position: absolute; top: 369px; height: 100px">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td valign="top" align="left">
                                                <strong>
                                                    <asp:Label ID="Label15" runat="server" Width="74px" Text="Stock Use By"></asp:Label></strong>
                                            </td>
                                            <td valign="top" align="left" colspan="3">
                                                <asp:DropDownList ID="drpAssignedDistributor" runat="server" Width="231px"
                                                    OnSelectedIndexChanged="drpAssignedDistributor_SelectedIndexChanged" AutoPostBack="True">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" Height="130px" ScrollBars="Vertical" Width="102%"
                                        ...
                                        <asp:GridView ID="GrdPurchase" runat="server" ForeColor="SteelBlue"
                                            ...
                                            ShowHeader="False" OnRowDeleting="GrdPurchase_RowDeleting" OnRowCommand="GrdPurchase_RowCommand" Width="100%">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="SKU_NAME" HeaderText="SKU Name" ReadOnly="true">
                                                    <ItemStyle HorizontalAlign="Left" BorderColor="Silver" BorderWidth="2px" BorderStyle="Solid" Width="26%"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="QUANTITY_CTN" HeaderText="Ctn" ReadOnly="true">
                                                    <ItemStyle HorizontalAlign="Right" BorderColor="Silver" BorderWidth="2px" BorderStyle="Solid" Width="8%"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="QUANTITY_UNIT" HeaderText="Quantity" ReadOnly="true">
                                                    <ItemStyle HorizontalAlign="Right" BorderColor="Silver" BorderWidth="2px" BorderStyle="Solid" Width="8%"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="UNIT_PRICE" HeaderText="PRICE" DataFormatString="{0:F2}" ReadOnly="true">
                                                    <ItemStyle HorizontalAlign="Right" BorderColor="Silver" BorderWidth="2px" BorderStyle="Solid" Width="8%"></ItemStyle>
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="EXTRA_DISCOUNT_PER" HeaderText="Ext. Discount" DataFormatString="{0:F2}" ReadOnly="true">
                                                    <ItemStyle HorizontalAlign="Right" BorderColor="Silver" BorderWidth="2px" BorderStyle="Solid" Width="8%"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="EXTRA_DISCOUNT" HeaderText="Ext. Dis Value" DataFormatString="{0:F2}" ReadOnly="true">
                                                    <ItemStyle HorizontalAlign="Right" BorderColor="Silver" BorderWidth="2px" BorderStyle="Solid" Width="8%"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="NET_AMOUNT" HeaderText="Net Value" DataFormatString="{0:F2}" ReadOnly="true">
                                                    <ItemStyle HorizontalAlign="Right" BorderColor="Silver" BorderWidth="2px" BorderStyle="Solid" Width="8%"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="QUANTITY_CTN2" HeaderText="QUANTITY_CTN2" ReadOnly="true">
                                                    <HeaderStyle CssClass="HidePanel" />
                                                    <ItemStyle CssClass="HidePanel" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="QUANTITY_UNIT2" HeaderText="QUANTITY_UNIT2" ReadOnly="true">
                                                    <HeaderStyle CssClass="HidePanel" />
                                                    <ItemStyle CssClass="HidePanel" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="UNITS_IN_CASE" HeaderText="UNITS_IN_CASE" ReadOnly="true">
                                                    <HeaderStyle CssClass="HidePanel" />
                                                    <ItemStyle CssClass="HidePanel" />
                                                </asp:BoundField>
                                                ...
                                                <asp:TemplateField HeaderText="Delete">
                                                    ...
                                                    <ItemStyle BorderColor="Silver" BorderWidth="2px" BorderStyle="Solid"></ItemStyle>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                    </asp:Panel>
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td style="width: 26%" align="right">Total
                                            </td>
                            ...
                            <ContentTemplate>
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width: 1px; height: 20px" valign="top"></td>
