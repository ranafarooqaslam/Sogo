...
public partial class Forms_frmRptReconcilation : System.Web.UI.Page
{
    ...
    private void ShowReport(int p_Report_Type)
    {
        ...
        DataSet ds = RptSaleCtl.SelectValueReconcilation(int.Parse(drpDistributor.SelectedValue.ToString()), Convert.ToInt32(DrpPrincipal.SelectedValue), ReportType, DateTime.Parse(txtStartDate.Text + " 00:00:00"), DateTime.Parse(txtEndDate.Text + " 23:59:59"), int.Parse(this.Session["UserId"].ToString()),Convert.ToInt32(ddDistributorType.SelectedValue));
