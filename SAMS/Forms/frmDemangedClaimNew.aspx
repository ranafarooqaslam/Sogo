<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmDemangedClaimNew.aspx.cs" Inherits="Forms_frmDemangedClaimNew" Title="SAMS: Customer Claim" %>
                                ...
                                <asp:Panel ID="Panel1" runat="server" DefaultButton="btnAddNew">
                                    <table>
                                        <tr>
                                            ...
                                            <td valign="middle" align="left"  rowspan="8">
                                                <asp:Panel ID="Panel2" runat="server" Height="150px" ScrollBars="Vertical" BorderColor="Silver"
                                                    BorderStyle="Groove" BorderWidth="1px" Width="400px">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" style="height: 20px">
                                                <asp:DropDownList ID="DrpCustomer" runat="server" Width="250px" OnSelectedIndexChanged="DrpCustomer_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </td> <td style="width: 3px">
                                            </td><td></td>
                                        </tr>
