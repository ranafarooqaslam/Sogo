                        ...
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="Label5" runat="server" Text="Value Type" Width="78px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="Label7" runat="server" Text="Location Type" Width="101px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
                                    <td align="left" style="height: 25px">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="lbltoLocation" runat="server" Text="Location" Width="66px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
                                    <td align="left" style="height: 25px">
