                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <strong>
                                                <asp:Label ID="Label1" runat="server" Width="103px" Text="Report Type"></asp:Label></strong>
                                        </td>
                                        <td align="left">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <strong>
                                                <asp:Label ID="Label5" runat="server" Width="79px" Text="Sale Force"></asp:Label></strong>
                                        </td>
                                        <td align="left">
                                        </td>
                                        <td style="height: 25px" align="left">
