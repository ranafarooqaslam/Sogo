<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="rptSKULedger.aspx.cs" Inherits="Forms_rptSKULedger"
    Title="SAMS: SKU Ledger" %>
                            ...
                            <table>                                
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="height: 25px">
                                        <asp:DropDownList ID="ddlPrincipal" runat="server" Width="200px" AutoPostBack="true" OnSelectedIndexChanged="ddlPrincipal_SelectedIndexChanged"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                ...
                                <tr>
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="Label1" runat="server" Text="SKU" Width="78px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
                                    <td align="left" style="height: 25px">
