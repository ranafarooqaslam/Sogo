<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="rptCreditDebitNote.aspx.cs" Inherits="Forms_rptCreditDebitNote"
    Title="SAMS: Credit-Debit Note" %>
                            ...
                            <table>
                                <tbody>         
                                    <tr>
                                        ...
                                        <td align="left">
                                            <strong>
                                                <asp:Label ID="Label2" runat="server" Text="Report Type"></asp:Label></strong>
                                        </td>
                                        <td style="width: 1px" align="left">
                                        </td>
                                        <td style="height: 25px" align="left">
                                            <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="383" Text="Credit Note" Selected="True"></asp:ListItem>
                                                <asp:ListItem Value="378" Text="Debit Note"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <strong>
                                                <asp:Label ID="Label1" runat="server" Width="66px" Text="City"></asp:Label></strong>
                                        </td>
                                        <td style="width: 1px" align="left">
                                        </td>
                                        <td style="width: 201px; height: 25px" align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <strong>
                                                <asp:Label ID="Label3" runat="server" Text="Channel Type"></asp:Label></strong>
                                        </td>
                                        <td style="width: 1px" align="left">
                                        </td>
                                        <td style="width: 201px; height: 25px" align="left">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="padding-left: 5px; width: 8px; height: 25px">
                                                                <strong>
                                                                    <asp:Label ID="lblFromMonth" runat="server" Width="78px" Text="From Date"></asp:Label></strong>
                                                            </td>
                                                            <td style="width: 20px">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="padding-left: 5px; width: 8px; height: 25px">
                                                                <strong>
                                                                    <asp:Label ID="lblToMonth" runat="server" Width="78px" Text="To Date"></asp:Label></strong>
                                                            </td>
