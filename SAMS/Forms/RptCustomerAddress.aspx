<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptCustomerAddress.aspx.cs" Inherits="Forms_RptCustomerAddress" Title="SAMS: Customer Address Report" %>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <strong>
                                                <asp:Label ID="Label7" runat="server" Width="94px" Text="City"></asp:Label></strong>
                                        </td>
                                        <td align="left">
                                        </td>
                                        <td style="height: 25px" align="left">
                                            <asp:DropDownList ID="ddlCity" runat="server" Width="200px" OnSelectedIndexChanged="ddlCity_SelectedIndexChanged"
                                                AutoPostBack="True">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="left">
                                            <strong>
                                                <asp:Label ID="lblfromLocation" runat="server" Width="94px" Text="Customer Area"></asp:Label></strong>
                                        </td>
                                        <td align="left">
                                        </td>
                                        <td style="height: 25px" align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <strong>
                                                <asp:Label ID="lblCustomer" runat="server" Width="78px" Text="Customer"></asp:Label></strong>
                                        </td>
                                        <td align="left">
                                        </td>
                                        <td style="height: 25px" align="left">
