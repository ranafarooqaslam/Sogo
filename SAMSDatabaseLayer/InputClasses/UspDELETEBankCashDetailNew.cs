...
{
	public class UspDELETEBankCashDetailNew
	{
		#region Private Members
		private string sp_Name = " UspDELETEBankCashDetailNew" ;
		...
		#region Constructor
        public UspDELETEBankCashDetailNew()
        {
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspDELETEBankCashDetailNew";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspDELETEBankCashDetailNew";
