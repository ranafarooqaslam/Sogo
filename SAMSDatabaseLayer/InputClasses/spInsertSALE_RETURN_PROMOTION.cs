...
{
    public class spInsertSALE_RETURN_PROMOTION
    {
        #region Private Members
        private string sp_Name = " spInsertSALE_RETURN_PROMOTION";
        ...
        private long m_SALE_RETURN_ID;
        private long m_SALE_RETURN_PROMOTION_ID;
        #endregion
        ...
        public long SALE_RETURN_ID
        {
            set
            {
                m_SALE_RETURN_ID = value;
            }
            get
            {
                return m_SALE_RETURN_ID;
            }
        }

     
        public long SALE_RETURN_PROMOTION_ID
        {
            get
            {
                return m_SALE_RETURN_PROMOTION_ID;
            }
        }
        ...
        #region Constructor
        public spInsertSALE_RETURN_PROMOTION()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertSALE_RETURN_PROMOTION";
                ...
                cmd.ExecuteNonQuery();
                m_SALE_RETURN_PROMOTION_ID = (long)((IDataParameter)(cmd.Parameters["@SALE_RETURN_PROMOTION_ID"])).Value;
                return true;
            }
            catch (Exception e)
            {
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spInsertSALE_RETURN_PROMOTION";
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                ...
                m_SALE_RETURN_ID = Convert.ToInt64(dr["SALE_RETURN_ID"]);
                m_SALE_RETURN_PROMOTION_ID = Convert.ToInt64(dr["SALE_RETURN_PROMOTION_ID"]);
            }
        }
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@SALE_RETURN_ID";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.BigInt);
            if (m_SALE_RETURN_ID == Constants.LongNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_SALE_RETURN_ID;
            }
            pparams.Add(parameter);

            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@SALE_RETURN_PROMOTION_ID";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.BigInt);
