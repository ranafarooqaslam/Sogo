...
{
	public class uspGetPaymentVoucher2
	{
		#region Private Members
		private string sp_Name = "uspGetPaymentVoucher2" ;
        ...
        {
            set { m_ChannelTypeID = value; }
            get { return m_ChannelTypeID; }
        }
