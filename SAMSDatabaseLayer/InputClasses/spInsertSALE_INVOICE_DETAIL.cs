...
namespace SAMSDatabaseLayer.Classes
{
    public class spInsertSALE_INVOICE_DETAIL
    {
        ...
        private decimal m_CURRENT_CREDIT;
        ...
        {
            set { m_CURRENT_CREDIT = value; }
            get { return m_CURRENT_CREDIT; }
        }
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@CURRENT_CREDIT";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Money);
            if (m_CURRENT_CREDIT == Constants.DecimalNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_CURRENT_CREDIT;
            }
            pparams.Add(parameter);
