...
{
	public class UspSelectBankCashDetail2
	{
		#region Private Members
		private string sp_Name = " UspSelectBankCashDetail2" ;
		...
		#region Constructor
		public UspSelectBankCashDetail2()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspSelectBankCashDetail2";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspSelectBankCashDetail2";
