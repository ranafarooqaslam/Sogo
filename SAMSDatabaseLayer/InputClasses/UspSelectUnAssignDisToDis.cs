...
{
	public class UspSelectUnAssignDisToDis
	{
        #region Private Members
        private string sp_Name = "UspSelectUnAssignDisToDis";
        private IDbConnection m_connection;
        private IDbTransaction m_transaction;
        private int m_DISTRIBUTOR_ID;
        private int m_ASSIGNED_DISTRIBUTOR_TYPE;
        ...
        public int ASSIGNED_DISTRIBUTOR_TYPE
        {
            set
            {
                m_ASSIGNED_DISTRIBUTOR_TYPE = value;
            }
            get
            {
                return m_ASSIGNED_DISTRIBUTOR_TYPE;
            }
        }
        ...
        #endregion
        #region Constructor
        public UspSelectUnAssignDisToDis()
        {
            m_DAY_CLOSE = Constants.DateNullValue;
        }
        #endregion
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                ...
                m_ASSIGNED_DISTRIBUTOR_TYPE = Convert.ToInt32(dr["ASSIGNED_DISTRIBUTOR_TYPE"]);
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@ASSIGNED_DISTRIBUTOR_TYPE";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);
            if (m_ASSIGNED_DISTRIBUTOR_TYPE == Constants.IntNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_ASSIGNED_DISTRIBUTOR_TYPE;
            }
            pparams.Add(parameter);
