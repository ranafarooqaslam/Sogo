...
namespace SAMSDatabaseLayer.Classes
{
    public class uspGetStockValuation
    {
        ...
        private int m_TYPE;
        private bool m_ZERO_ELIMINATION;
        #endregion
        ...
        public bool ZERO_ELIMINATION
        {
            set { m_ZERO_ELIMINATION = value; }
            get { return m_ZERO_ELIMINATION; }
        }
        public DateTime STOCK_DATE
        {
            set { m_STOCK_DATE = value; }
            get { return m_STOCK_DATE; }
        }
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@ZERO_ELIMINATION";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Bit);
            parameter.Value = m_ZERO_ELIMINATION;
            pparams.Add(parameter);
        }
