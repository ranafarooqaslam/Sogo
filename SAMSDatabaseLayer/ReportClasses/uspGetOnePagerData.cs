...
{
	public class uspGetOnePagerData
	{
		#region Private Members
		private string sp_Name = " uspGetOnePagerData" ;
		...
		#region Constructor
        public uspGetOnePagerData()
        {
            m_DISTRIBUTOR_IDs = null;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspGetOnePagerData";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspGetOnePagerData";
		...
		public string ExecuteScalar()
		{
			...
			public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
					m_DISTRIBUTOR_IDs= dr["DISTRIBUTOR_ID"].ToString();
